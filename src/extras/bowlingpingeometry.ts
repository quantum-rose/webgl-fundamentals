...
export interface IBowlingPinGeometryParameters {
    widthSegments: number;
    heightSegments: number;
}

export class BowlingPinGeometry extends BufferGeometry {
    // 多段连续三次贝塞尔曲线的控制点
    ...
    public parameters: IBowlingPinGeometryParameters;
    ...
    constructor(widthSegments = 16, heightSegments = 4) {
        ...
        // 组合为贝塞尔曲线
        const segments = BowlingPinGeometry._segments;
